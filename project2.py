...
intensity_centerums_x = [-0.8, 0.5, -0.4, 0.0, 0.4]
intensity_centerums_y = [0.0, 0.3, -0.5, -0.7, -0.5]
intensity_values = [1, 1.7, 1, 0.7, 1]
...
gas_velocity = np.zeros([gas_part_num, 3], dtype=float_type)
...
for i in range(len(x_p)):
   ...
   gas_velocity[i][0] = float_type(0.001)
   gas_velocity[i][1] = float_type(0)
...
part0.create_dataset("Velocity", data = gas_velocity)
